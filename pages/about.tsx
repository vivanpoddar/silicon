        ...
        <>
            ...
            <div>
                <div className="pt-24 bg-white flex flex-col justify-center items-center">
                    <h1 className="md:text-7xl text-3xl text-black text-center">Compete. Compute. Connect.</h1>
                    <motion.div
                    ...
                    <div className="justify-items-center items-center text-black flex flex-col p-2">
                        ...
                        <div className="md:pl-40 md:pr-40">
                            ...
                            <p className="md:text-4xl">
                                We are looking to begin our journey by hosting a hackathon in Spring of 2024, shady.Hacks.
                            </p>
                        </div>
                    </div>
                </div>
