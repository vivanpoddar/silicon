            ...
            <div className="overflow-hidden">
                <div className="flex bg-black justify-center">
                    <div className="pt-24 pb-24 px-4 flex-col justify-center">
                        <h1 className="text-2xl text-white">Board of Directors</h1>
                        <div className="border-b w-full mb-2"></div>
                        <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
                            <Person image="/1671118383023.jpg" name="Vivan Poddar" position="Executive Director" text="" linkedin="https://www.linkedin.com/in/vivanpoddar" email="mailto:vivanneil@outlook.com" />
                            <Person image="/evan.png" name="Evan Xiang" position="Operations Director" text="" linkedin="https://www.linkedin.com/in/evan-xiang-4483b7231/" email="mailto:evankxiang@gmail.com" />
