            ...
            <div className="absolute w-screen h-screen flex items-center justify-center flex-col" style={{ height: "100vh" }}>
                ...
                <div className="flex space-x-4">
                    <div className="grid grid-cols-2 xl:-grid-cols-3 lg:grid-cols-4 pt-8 gap-1 xl:gap-4">
                        ...
                        <a href="https://drive.google.com/file/d/1X0Jd8n0rW3EhQhP_2tSPOMt7C3oB6zjz/view?usp=sharing" className="text-center mt-4 border  text-white py-1 px-2 xl:py-2 xl:px-4 xl:text-2xl rounded">Sponsor Info</a>
