        ...
        <div >
            <div className="text-white">
                ...
                <div className="p-4">
                    ...
                    <Question question="Technology and devices included?" answer="Everything you might need will be included free of charge. However, if you would like to work with more advanced components you will be required to bring your own. However, if this is difficult to do, shoot us an email and we will be able to accomodate your needs ahead of time." />
