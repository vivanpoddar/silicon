...
const HackathonCard = ({ title, date, location, description, image, logo, landscapeImage, registrationLink, status }: HackathonProps) => {
    ...
    return (
        <motion.div 
            className="bg-gray-900 border border-gray-700 rounded-lg p-6 m-4 hover:border-blue-500 transition-colors duration-300"
        ...
        >
            ...
            <div className="flex justify-between items-start mb-2">
                <div className="flex items-center gap-1">
                    {logo && (
                        <Image src={logo} width={50} height={50} alt={`${title} logo`} className="rounded opacity-60" />
                    )}
            ...
            <p className="text-gray-400 mb-2">{date} • {location}</p>
            ...
            <div className="min-h-screen bg-black relative overflow-hidden">
                ...
                >
                    <div className="max-w-7xl mx-auto text-center">
                        ...
                        >
                            Discover exciting hackathons and coding competitions designed to inspire and challenge high school students across the nation and beyond. These are the places that make it possible.
                        </motion.p>
                    </div>
